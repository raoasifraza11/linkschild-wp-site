...
if (function_exists('vc_map')) {
    vc_map(array(
        ...
        'name' => esc_html__('Tiny Image', 'softlab'),
        ...
        'params' => array(
            ...
            array(
                ...
                'fields' => array(
                    'element' => array(
                        'image_url' => get_template_directory_uri() . '/img/wgl_composer_addon/icons/pag_circle.png',
                        'label' => esc_html__('On element', 'softlab')),
                    'offset_element' => array(
                        'image_url' => get_template_directory_uri() . '/img/wgl_composer_addon/icons/pag_circle_border.png',
                        'label' => esc_html__('Offset Element', 'softlab')),
                ),
                'group' => esc_html__( 'Carousel', 'softlab' ),
                'dependency' => array(
    ...
    Softlab_Loop_Settings::init('wgl_blog_posts_tiny_img');
