...
$el_class .= isset($menu_alignment) && !empty($menu_alignment) ? ' menu-item-'.$menu_alignment : '';
...
if ( is_object( $wp_widget_factory ) && isset( $wp_widget_factory->widgets, $wp_widget_factory->widgets[ $type ] ) ) {
	...
	echo Softlab_Theme_Helper::render_html( $this->debugComment( 'Widget ' . esc_attr( $type ) . 'Not found in : vc_wp_custommenu' ) );
}
